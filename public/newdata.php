<?php
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      if (sizeof($parts) > 2) {
        ...
        $uhoh = array("shit", "piss", "fuck", "damn", "bitch", "crap", "dick",
        "cock", "pussy", "asshole", "bastard", "slut", "douche", "cunt", "fag",
        "cum", "shum", "milf", "fart", "bugger", "tard", "schlong", "nigga",
        "coon", "nigger", "chink", "wetback", "guido", "cush", "kyke", "squaw",
        "twat", "boob", "dyke", "coolie", "dago", "gook", "gringo", "wank",
        "gypsy", "negress", "porn", "dike", "poofter", "pansy", "mongol", "schizo",
        "spaz", "whore", "bimbo", "ghetto", "sleez", "poon", "biatch", "shart",
        "poop", "rape", "nazi", "vagina", "penis", "butt", "anus", "nipple",
        "vag", "tit", "anal", "spic", "dink", "nip", "wog", "ditz", "moham", "turd",
        "twat","poot","queef","jizz","blowjob", "clitoris", "testicles", "poon",
        "fuc","fuk","ass","handjob", "bqxgpbqxgp");
